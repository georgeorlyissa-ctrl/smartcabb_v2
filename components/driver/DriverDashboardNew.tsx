...
export function DriverDashboardNew() {
  ...
  // 3b. Watcher: quand une notif est visible, vérifier toutes les 3s si la course est encore disponible
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-orange-700 mt-1">
                      Minimum requis : {getMinimumCreditForCategory(driver.vehicle?.category || 'smart_standard').toLocaleString('fr-FR')} CDF
                      {' '}(15% du tarif de base {driver.vehicle?.category ? `— ${driver.vehicle.category.replace('smart_', '')}` : ''}).
                      Rechargez votre compte pour vous mettre en ligne.
                    </p>
      ...
      {/* Bottom Navigation */}
<div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-2 pb-[env(safe-area-inset-bottom)]">
