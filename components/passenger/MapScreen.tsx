...
export function MapScreen() {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col bg-white relative">
      ...
      <div className="absolute top-0 left-0 right-0 z-[1000] bg-white shadow-md">
        <div className="flex items-center justify-between px-3 py-2.5 gap-1.5">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            {/* Notifications */}
            <NotificationBell target="passengers" onOpen={() => setCurrentScreen('notifications')} />
          </div>
        </div>
      ...
      {/* ========== PANNEAU INFÉRIEUR ========== */}
      <div className="absolute bottom-0 left-0 right-0 z-[1000] bg-white rounded-t-3xl shadow-2xl pb-[env(safe-area-inset-bottom)]" style={{ maxHeight: '52vh' }}>
